...
def res(jobfile):
    ...
    app.config['UPLOAD_FOLDER'] = '/Users/lv04cs/Downloads/Automated-Resume-Screening-System/Original_Resumes/'
    app.config['ALLOWED_EXTENSIONS'] = set(['txt', 'pdf', 'png', 'jpg', 'jpeg', 'gif'])
    ...
    Resumes = []
    Temp_pdf = ''
    os.chdir('/Users/lv04cs/Downloads/Automated-Resume-Screening-System/Original_Resumes')
